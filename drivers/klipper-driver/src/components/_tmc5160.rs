...
pub struct Tmc5160 {
    ...
    /// 
    pub driver_FD3: Option<f64>,
    /// 
    pub driver_TPFD: Option<f64>,
    /// 
    pub driver_CHM: Option<f64>,
    /// 
    pub driver_VHIGHFS: Option<f64>,
    /// 
    pub driver_VHIGHCHM: Option<f64>,
    /// 
    pub driver_DISS2G: Option<f64>,
    /// 
    pub driver_DISS2VS: Option<f64>,
    /// 
    ...
    /// 
    pub driver_FREEWHEEL: Option<f64>,
    /// 
